      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-white/80 backdrop-blur-md shadow-2xl border-0">
          <CardHeader className="text-center pb-8">
            ...
            <p className="text-gray-600 mt-2">Sign in to your Smart Timetable account</p>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-white/60 border-gray-200 focus:border-blue-500 focus:ring-blue-500"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="bg-white/60 border-gray-200 focus:border-blue-500 focus:ring-blue-500 pr-10"
                    required
                  />
                  <Button
                    type="button"
